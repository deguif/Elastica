 ...
 * @internal
 */
class CommonQueryTest extends BaseTest
{
    /**
     * @group unit
     */
    ...
    {
        $query = new CommonQuery('body', 'test query', .001);
        $query->setLowFrequencyOperator(CommonQuery::OPERATOR_AND);
    ...
    public function testQuery(): void
    {
        ...
        $query = new CommonQuery('body', 'foo bar baz bat', .5);

 ...
 * @internal
 */
class DistanceFeatureQueryTest extends BaseTest
{
    /**
     * @group unit
     */
    ...
    {
        $query = new DistanceFeatureQuery('field_date', 'now', '7d');
    ...
    {
        $query = new DistanceFeatureQuery('field_geo_point', [-71.3, 41.15], '1000m');

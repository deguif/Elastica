 ...
 * @internal
 */
class GeoDistanceQueryTest extends BaseTest
{
    /**
     * @group functional
     */
    public function testGeoPoint(): void
    {
        ...
        $geoQuery = new GeoDistanceQuery('point', ['lat' => 30, 'lon' => 40], '1km');
        $query = new Query();
        ...
        $geoQuery = new GeoDistanceQuery('point', ['lat' => 30, 'lon' => 40], '40000km');
        $query = new Query();
        $query->setPostFilter($geoQuery);
    ...
    public function testConstructLatlon(): void
    {
        ...
        $query = new GeoDistanceQuery($key, $location, $distance);
    ...
    {
        $query = new GeoDistanceQuery('location', ['lat' => 48.86, 'lon' => 2.35], '10km');
        $distanceType = GeoDistanceQuery::DISTANCE_TYPE_ARC;

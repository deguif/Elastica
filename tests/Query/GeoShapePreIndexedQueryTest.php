...
use Elastica\Query\GeoShapePreIndexedQuery;
use Elastica\Test\Base as BaseTest;

/**
 * @internal
 */
class GeoShapePreIndexedQueryTest extends BaseTest
{
    /**
     * @group functional
     */
    public function testSearch(): void
    {
        ...
        $gsp = new GeoShapePreIndexedQuery(
            'location',
            '2',
            $indexName,
            'location'
    ...
    {
        $gsp = new GeoShapePreIndexedQuery('location', '1', 'indexName', 'location');

...
use Elastica\Query\GeoShapeProvidedQuery;
use Elastica\Test\Base as BaseTest;

/**
 * @internal
 */
class GeoShapeProvidedQueryTest extends BaseTest
{
    /**
     * @group functional
     */
    public function testSearch(): void
    {
        ...
        $gsp = new GeoShapeProvidedQuery('location', $envelope);
    ...
    public function testConstructEnvelope(): void
    {
        ...
        $expected = [
            'geo_shape' => [
                'location' => [
                    'shape' => [
                        'type' => GeoShapeProvidedQuery::TYPE_ENVELOPE,
    ...
    public function testConstructPolygon(): void
    {
        ...
        $gsp = new GeoShapeProvidedQuery('location', $polygon, GeoShapeProvidedQuery::TYPE_POLYGON);

        $expected = [
            'geo_shape' => [
                'location' => [
                    'shape' => [
                        'type' => GeoShapeProvidedQuery::TYPE_POLYGON,
                        'coordinates' => $polygon,
                    ],
                    'relation' => $gsp->getRelation(),
                ],
    ...
    {
        $gsp = new GeoShapeProvidedQuery('location', [[25.0, 75.0], [75.0, 25.0]]);

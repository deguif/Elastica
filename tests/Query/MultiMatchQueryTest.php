 ...
 * @internal
 */
class MultiMatchQueryTest extends BaseTest
{
    private static $data = [
    ...
    public function testAndOperator(): void
    {
        ...
        $multiMatch->setFields(['full_name', 'name']);
        $multiMatch->setOperator(MultiMatchQuery::OPERATOR_AND);
        $resultSet = $this->_getResults($multiMatch);
    ...
    public function testType(): void
    {
        ...
        $multiMatch->setFields(['full_name', 'name']);
        $multiMatch->setType(MultiMatchQuery::TYPE_PHRASE_PREFIX);
        $resultSet = $this->_getResults($multiMatch);
    ...
    public function testFuzzy(): void
    {
        ...
        $multiMatch->setQuery('Tritsan'); // Misspell on purpose
        $multiMatch->setFields(['full_name', 'name']);
        $multiMatch->setFuzziness(MultiMatchQuery::FUZZINESS_AUTO);
        $resultSet = $this->_getResults($multiMatch);
    ...
    public function testZeroTerm(): void
    {
        ...
        $multiMatch->setZeroTermsQuery(MultiMatchQuery::ZERO_TERM_NONE);
        $multiMatch->setAnalyzer('stops');
        $resultSet = $this->_getResults($multiMatch);

        $this->assertEquals(0, $resultSet->count());

        $multiMatch->setZeroTermsQuery(MultiMatchQuery::ZERO_TERM_ALL);
        $resultSet = $this->_getResults($multiMatch);
     ...
     */
    private function _getResults(MultiMatchQuery $multiMatch): ResultSet
    {

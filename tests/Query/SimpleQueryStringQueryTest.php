 ...
 * @internal
 */
class SimpleQueryStringQueryTest extends Base
{
    /**
     * @group unit
     */
    public function testToArray(): void
    {
        ...
        $query = new SimpleQueryStringQuery($string, $fields);
        $query->setDefaultOperator(SimpleQueryStringQuery::OPERATOR_OR);
        ...
        $expected = [
            'simple_query_string' => [
                ...
                'fields' => $fields,
                'analyzer' => 'whitespace',
                'default_operator' => SimpleQueryStringQuery::OPERATOR_OR,
            ],
        ];
    ...
    public function testQuery(): void
    {
        ...
        $query = new SimpleQueryStringQuery('gibson +sg +-faded', ['make', 'model']);
    ...
    public function testSetMinimumShouldMatch(): void
    {
        ...
        $query = (new SimpleQueryStringQuery($expected['simple_query_string']['query']))
    ...
    public function testSetMinimumShouldMatchWorks(): void
    {
        ...
        $query = new SimpleQueryStringQuery('foo bar');
